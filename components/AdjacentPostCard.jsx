...
export default function AdjacentPostCard({ post, position }) {
  return (
    <>
      ...
      {position === 'LEFT' && (
        <div className="absolute arrow-btn bottom-5 text-center py-3 px-3 cursor-pointer bg-blue-600 left-4 rounded-full adjacent-post">
      ...
      {position === 'RIGHT' && (
        <div className="absolute arrow-btn bottom-5 text-center py-3 px-3 cursor-pointer bg-blue-600 right-4 rounded-full adjacent-post">
